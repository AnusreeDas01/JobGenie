...
def render_html_report(score, matched, total, matched_keywords, missing_keywords, summary, skill_gap, suggestions, rewritten):
    html_content = f"""
    <style>
        body {{
    ...
    <br><br>
    <p style='text-align:center;font-style:italic;color:#888;'>💡 Tip: Press Ctrl+P or right-click > Print to save this as a PDF</p>
    """
    return html_content
